...
<body class="hold-transition skin-blue-light sidebar-mini">
			...
			<section class="content">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">组织管理 > 车间列表 > 新增车间</h3>
					</div>
					<div class="box-body form-horizontal">
				      <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="name" value="${workshop.name}" maxlength="100" placeholder="车间名称" >
							</div>
						</div>
						<div class="form-group">
	...
	<script src="${pageContext.request.contextPath}/resources/admin/js/workshop/add.js"></script>
</body>
</html>
