...
<body class="hold-transition skin-blue-light sidebar-mini">
			...
			<section class="content">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">工具管理 > 基本信息列表 > 编辑基本信息</h3>
					</div>
					<div class="box-body form-horizontal">
					<input id="id" type="hidden" value="${basic.id}" >
								...
								<select class="form-control" id="code" name ="code" >
									...
									<c:forEach items="${types}" var="temp" >
										<option value="${temp.code}"
											<c:if test="${basic.code==temp.code}">selected</c:if>
	...
	<script src="${pageContext.request.contextPath}/resources/admin/js/devicebasic/edit.js"></script>
</body>
</html>
