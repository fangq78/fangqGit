...
<body class="hold-transition skin-blue-light sidebar-mini">
			...
			<section class="content">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">工具管理 > 物资编码列表 > 新增物资编码</h3>
					</div>
					<div class="box-body form-horizontal">
						<div class="form-group">
							<label class="col-sm-3 control-label" for="code"><code>*</code>物资编码</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" id="code" value="${deviceType.code}" maxlength="20" placeholder="物资编码" >
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="comment" value="${depot.comment}" maxlength="100" placeholder="说明" >
							</div>
						</div>
					</div>
	...
	<script src="${pageContext.request.contextPath}/resources/admin/js/devicetype/add.js"></script>
</body>
</html>
