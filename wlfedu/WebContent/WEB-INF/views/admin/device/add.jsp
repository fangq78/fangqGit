...
<body class="hold-transition skin-blue-light sidebar-mini">
			...
			<section class="content">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">工具管理 > 工具基本信息 > 工具信息列表 > 批量增加工具</h3>
					</div>
					...
					<div class="box-body form-horizontal">
				      <div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" for="factory">物资编码名称</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" for="count"><code>*</code>数量</label>
							<div class="col-sm-1">
								<input type="text" class="form-control" id="count"   maxlength="3" placeholder="数量" >
							</div>
						</div>
					</div>
	...
	<script src="${pageContext.request.contextPath}/resources/admin/js/device/add.js"></script>
</body>
</html>
