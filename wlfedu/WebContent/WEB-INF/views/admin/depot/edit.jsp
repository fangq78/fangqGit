...
<body class="hold-transition skin-blue-light sidebar-mini">
			...
			<section class="content">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">组织管理 > 段列表 > 编辑段</h3>
					</div>
					<input id="id" type="hidden" value="${depot.id}" >
	...
	<script src="${pageContext.request.contextPath}/resources/admin/js/depot/edit.js"></script>
</body>
</html>
