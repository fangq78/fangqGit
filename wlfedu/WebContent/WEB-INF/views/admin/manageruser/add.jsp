...
<body class="hold-transition skin-blue-light sidebar-mini">
			...
			<section class="content">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">组织管理 > 管理员列表 > 新增管理员</h3>
					</div>
					<div class="box-body form-horizontal">
						<div class="form-group">
							<label class="col-sm-3 control-label" for="name" ><code>*</code>用户名</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" id="name" value="${user.name}" maxlength="20" placeholder="用户名" >
							</div>
						</div>
						<div class="form-group">
	...
	<script src="${pageContext.request.contextPath}/resources/admin/js/manageruser/add.js"></script>
</body>
</html>
