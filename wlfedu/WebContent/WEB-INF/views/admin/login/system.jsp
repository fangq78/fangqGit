...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="login-box-body">
      ...
      <form id="userForm" action="${pageContext.request.contextPath}/admin/login/doSystem" method="post"> 
  ...
  <script src="${pageContext.request.contextPath}/resources/admin/js/login/system.js"></script>
</body>
</html>