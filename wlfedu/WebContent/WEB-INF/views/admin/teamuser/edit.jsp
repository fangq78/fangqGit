...
<body class="hold-transition skin-blue-light sidebar-mini">
			...
			<section class="content">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">组织管理 > 管理员列表 > 编辑班组人员</h3>
					</div>
					<div class="box-body form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="name" value="${user.name}" maxlength="20" disabled placeholder="用户登录名" >
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select class="form-control" id="teamId" name ="teamId" >
									...
									<c:forEach items="${teams}" var="temp" >
										<option value="${temp.id}"
											<c:if test="${user.teamId==temp.id}">selected</c:if>
										>${temp.name}</option>
									</c:forEach>
								</select>
							</div>
	...
	<script src="${pageContext.request.contextPath}/resources/admin/js/teamuser/edit.js"></script>
</body>
</html>
